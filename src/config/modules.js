...
{ name: 'CC Conversion', 
  upload: '/api/cc/upload', 
  get: '/api/cc/getallcc_conversion',
  getByMonthYear :'/api/cc/getcc_conversion',
  deleteAll: "/api/cc/delete_all",
},
{ name: 'SA Conversion', 
  upload: '/api/sa/upload', 
  get: '/api/sa/getallsa_conversion',
  getByMonthYear :'/api/sa/getsa_conversion',
  deleteAll: "/api/sa/delete_all",
},
{ name: 'Sales', 
  upload: '/api/sales/upload', 
  get: '/api/sales/getallsales',
  getByMonthYear :'/api/sales/getsales',
  deleteAll: "/api/sales/delete_all",
},
{ name: 'Servicee', 
  upload: '/api/servicee/upload', 
  get: '/api/servicee/getallservicee',
  getByMonthYear :'/api/servicee/getservicee',
  deleteAll: "/api/servicee/delete_all",
},
{ name: 'Due Done', 
