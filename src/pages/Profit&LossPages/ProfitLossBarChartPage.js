...
function ProfitLossBarChartPage() {
  ...
  const [selectedGrowth, setSelectedGrowthState] = useState(() => {
    const saved = getSelectedGrowth("profit_loss");
    return saved || "Apr 24"; 
  });
  ...
  const growthKeyMap = {
    ...
    "SR&BR Sep 25": "sep25_per_100k",
    "SR&BR Oct 25": "oct25_per_100k",
    "SR&BR Nov 25": "nov25_per_100k",
    "SR&BR Dec 25": "dec25_per_100k",
    "SR&BR Jan 26": "jan26_per_100k",
    "SR&BR Feb 26": "feb26_per_100k",
    "SR&BR 2025 - 26": "total25_per_100k",
  };

  const twoDecimalGrowthOptions = [
  "Apr 24", "May 24", "Jun 24", "Jul 24","2024 - 25", "Apr 25", "May 25",  "Jun 25",
  "Jul 25", "Aug 25", "Sep 25","Oct 25", "Nov 25","Dec 25", "Jan 26", "Feb 26", "2025 - 26",
];
