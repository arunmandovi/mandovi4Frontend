...
function ProfitLossSRBRTablePage() {
  ...
  const loadCitySummary = async () => {
    try {
      ...
      let formatted = data.map((row) => ({
            ...
            "Jan 2026": formatNumber(row.jan26_per_100k),
            "Feb 2026": formatNumber(row.feb26_per_100k),
  ...
  "Krishnarajapet","Somvarpet", "Maddur", "Nagamangala", "Narasipura", "Mysore Nexa", "Kollegal", "Mandya Nexa","Gonikoppa Nexa", "MYSORE",
