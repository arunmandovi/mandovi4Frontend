    ...
    const fetchMonthlyData = async () => {
      try {
        ...
        for (const month of activeMonths) {
          ...
          const data = await fetchData(`/api/labour/labour_summary?${queryParams.toString()}`);
        ...
        const overallData = await fetchData(`/api/labour/labour_summary?${overallParams.toString()}`);
