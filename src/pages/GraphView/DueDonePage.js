...
function DueDonePage() {
  ...
  const beautifyHeader = (key) => {
    ...
    if (key.startsWith("done")) return "DONE";
    if (key.startsWith("percentage")) return "DONE %";
    return key;
  };
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", mb: 3 }}>
        <Typography variant="h4">DUE VS DONE GRAPH (CityWise)</Typography>
