...
function BatteryTyrePage() {
  ...
  const [selectedGrowth, setSelectedGrowthState] = useState(getSelectedGrowth("battery_tyre"));
    ...
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", mb: 3 }}>
        ...
        <Box sx={{ display: "flex", gap: 1 }}>
          ...
          <Button variant="contained" color="secondary" onClick={() => navigate("/DashboardHome/battery_tyre_branches-bar-chart")}>
            BranchWise
          </Button>
        </Box>
      </Box>
