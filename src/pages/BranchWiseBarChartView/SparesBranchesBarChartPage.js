...
function SparesBranchesBarChartPage() {
  ...
  useEffect(() => {
    const savedGrowth = getSelectedGrowth("spares");
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        ...
        const endpoint = `/api/spares/spares_branch_summary${params.toString()? "?"+params.toString():""}`;
    ...
    <Box sx={{p:3}}>
      ...
      <GrowthButtons
        ...
        setSelectedGrowth={(value)=>{
          ...
          setSelectedGrowth(value,"spares");
        }}
      />
...
export default SparesBranchesBarChartPage;
