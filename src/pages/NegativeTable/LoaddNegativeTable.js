  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        ...
        const endpoint = `/api/loadd/loadd_branch_summary?${params.toString()}`;
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", mb: 3 }}>
        <Typography variant="h4">LOAD Table (Branch-wise)</Typography>
...
export default LoaddNegativeTable;