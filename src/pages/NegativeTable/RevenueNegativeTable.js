...
const growthFormatConfig = {
  growthSRLabour: percentFormat,
  growthBRLabour: percentFormat,
  growthSRBRLabour: percentFormat,
  growthSRSpares: percentFormat,
  growthBRSpares: percentFormat,
  growthSRBRSpares: percentFormat,
  growthSRBRTotal: percentFormat,
};
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        ...
        const endpoint = `/api/revenue/revenue_branch_summary?${params.toString()}`;
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", mb: 3 }}>
        <Typography variant="h4">REVENUE Table (Branch-wise)</Typography>
...
export default RevenueNegativeTable;