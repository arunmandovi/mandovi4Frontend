  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", mb: 3 }}>
        <Typography variant="h4">LABOUR Table (Branch-wise)</Typography>
...
export default LabourNegativeTable;